...
export function AppShell({ children, email, branding, navigationItems, operationalContexts, operationHeader, userGuide, guideSteps, experienceMode }: { children: ReactNode; email: string | null; branding: ResolvedBranding; navigationItems: readonly ShellNavigationItem[]; operationalContexts: readonly OperationalContext[]; operationHeader: OperationHeaderData; userGuide: UserGuideState; guideSteps: readonly UserGuideStep[]; experienceMode: ExperienceMode }) {
  const style = {
