  ...
  return (
    <div className={styles.shell}>
      ...
      <aside className={styles.sidebar}>
        ...
        <nav className={styles.nav} aria-label="Painel do Proprietário">
      ...
      <div className={styles.main}>
        <header className={styles.topbar}>
          <div><strong>{roleLabel}</strong><span>{access.user.email ?? "Acesso de plataforma"}</span></div>
          <div className={styles.topActions}><ThemeSelector compact /><form action={signOutAction}><button type="submit" className={styles.exit}>Sair</button></form></div>
        </header>
