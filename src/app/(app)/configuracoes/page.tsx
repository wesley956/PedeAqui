...
const storeSettings = [
  ...
  { group: "Operação" as SettingsGroup, title: "Pagamentos", description: "Pix, cartões e dinheiro disponíveis para seus clientes.", href: "/configuracoes/pagamentos", permissions: [PERMISSIONS.STORES_VIEW] },
  { group: "Canais e integrações" as SettingsGroup, title: "Conversas e WhatsApp", description: "Conexão do WhatsApp, atendimento automático e mensagem de boas-vindas.", href: "/configuracoes/conversas", permissions: [PERMISSIONS.INTEGRATIONS_VIEW, PERMISSIONS.CONVERSATIONS_VIEW] },
  { group: "Canais e integrações" as SettingsGroup, title: "Impressões", description: "Impressoras, locais de impressão e acompanhamento da fila.", href: "/configuracoes/impressoes", permissions: [PERMISSIONS.PRINTING_VIEW] },
] as const;
...
const groupDescriptions: Record<SettingsGroup, string> = { Estabelecimento: "Identidade e funcionamento da unidade.", Operação: "Preferências que afetam atendimento, caixa, salão, entrega e pagamento.", "Canais e integrações": "Conexões e equipamentos que apoiam o atendimento do restaurante." };
...
export default async function SettingsPage() {
  ...
  return <section className={styles.root}>
    <header className={styles.header}><h1>Configurações</h1><p className="muted">Ajuste aqui as principais preferências da unidade de forma simples e centralizada.</p></header>
