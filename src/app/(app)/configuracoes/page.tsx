...
const definitions = {
  ...
  delivery: { title: "Entrega", description: "Bairros, taxas, prazo e frete grátis.", href: "/configuracoes/entrega", permissions: [PERMISSIONS.STORES_VIEW], keywords: ["bairro", "taxa", "frete", "entrega", "delivery", "prazo", "retirada"] , moduleKey: "deliveries" },
  ...
  printing: { title: "Conectar e acompanhar impressoras", description: "Print Agent, impressoras, locais e fila de impressão.", href: "/configuracoes/impressoes", permissions: [PERMISSIONS.PRINTING_VIEW], keywords: ["impressora", "imprimir", "impressao", "print agent", "cozinha", "conectar", "offline", "fila"] },
