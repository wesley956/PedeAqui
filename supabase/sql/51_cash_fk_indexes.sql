...
create index if not exists cash_registers_updated_by_idx on public.cash_registers (updated_by) where updated_by is not null;
...
create index if not exists cash_movements_order_fk_idx on public.cash_movements (organization_id, store_id, order_id) where order_id is not null;
create index if not exists cash_movements_reference_fk_idx on public.cash_movements (organization_id, store_id, reference_movement_id) where reference_movement_id is not null;
