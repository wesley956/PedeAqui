-- PedeAqui — pedidos já atendidos podem ser encerrados mesmo após estorno.
-- O estado financeiro permanece independente e preserva paid/partially_refunded/refunded no histórico.
