-- Restore the checkout order function after the gas integration replaced the
-- growth-aware implementation. This version preserves both domains.
...
begin
  ...
  where organization_id = v_cart.organization_id
    and store_id = v_cart.store_id
    and cart_id = v_cart.id
  for update;
